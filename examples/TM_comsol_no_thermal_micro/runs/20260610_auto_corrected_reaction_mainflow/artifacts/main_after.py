...
from corrected_reaction_postprocess import run_corrected_reaction_postprocess
...
field_comp = FieldComputation(
    ...
    coord_normalization=training_dict.get("coord_normalization", "none"),
)
...
if __name__ == "__main__":
    ...
    run_corrected_reaction_postprocess(
        model_path,
        results_path,
        out_dir=results_path / "curves",
        device="cpu",
    )
